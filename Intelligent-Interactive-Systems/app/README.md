...
```bash
git clone https://github.com/nelad1997/Intelligent-Interactive-Systems.git
cd Intelligent-Interactive-Systems/app
```
...
### 4. Configuration
Open the `.env` file in the `app/` folder and paste your Gemini API Key:
```env
